...
class PlayerActionsAdapter(context: Context,
    ...
    class ViewHolder(private val view: View,
        ...
        fun onClickOnActionName() {
            view.context.toast(action.name)
        }

        @OnLongClick(R.id.actionNameTextView)
        fun openPlayerActionMenu(view: View): Boolean {
            view.context.toast("${action.traits}")
